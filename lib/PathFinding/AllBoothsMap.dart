...
class AllBoothsMap {
  static List<BoothWidget> AllBoothsList = [
    BoothWidget(
      //Estande 1
  ...
  static List<BoothWidget> GetAllBoothsList() {
    return AllBoothsList;
  }

  static BoothWidget? GetBoothByBoothNumber(int boothNumber) {
    for (var booth in AllBoothsList) {
      if (booth.boothNumber == boothNumber) {
        return booth;
      }
    }
    return null;
